...
/*
 * Objeto de response para ser consumido do serviço Cambio-Service
 */
public class CambioResponse implements Serializable{
	...
	public CambioResponse(Long id, String from, String to, Double conversionFactor, Double convertedValue,
			String environment) {
		this.id = id;
		this.from = from;
		this.to = to;
